function init(){
    ...
    function nextSlide(pageNumber){
        ...
        const nextLeft = nextPage.querySelector('.hero .Actor-left');
        const nextRight = nextPage.querySelector('.hero .Actor-right');
        const currentLeft = currentPage.querySelector('.hero .Actor-left');
        const currentRight = currentPage.querySelector('.hero .Actor-right');
    ...
    const hamburgerLines = document.querySelectorAll('.lines line');
    ...
    .fromTo(social,0.5, {opacity: 0, y:10},{opacity: 1, y: 0}, '-=0.5')
           ...
           .fromTo(hamburgerLines, 0.2, {stroke:"white"}, {stroke:"red"}) ;
